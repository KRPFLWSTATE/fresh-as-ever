/** Shared shelf item display helpers (web parity with mobile shelfDisplay.ts). */
...
export function calcItemSavingsPercent(retailPrice, rescuePrice) {
...
export function formatItemSavings(retailPrice, rescuePrice) {
...
export function formatUnitLabel(input) {
...
export function formatLowStock(quantityRemaining) {
...
export function sumRetailSavingsForItems(items, quantities) {
...
export function formatBestBefore(dateStr) {
...
export function formatPickupByLabel(endIso) {

...
export function outletCategoryModeWarning(category) {
 ...
 * Category field is authoritative; this helps merchants catch misconfiguration.
 */
export function outletCategoryMismatchWarning(name, category) {
...
export function outletCategoryWarnings(name, category) {
  const out = [];
